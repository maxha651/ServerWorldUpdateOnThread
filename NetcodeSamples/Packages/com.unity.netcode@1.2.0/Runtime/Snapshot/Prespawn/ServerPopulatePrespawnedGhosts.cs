...
namespace Unity.NetCode
{
    ...
    public partial struct ServerPopulatePrespawnedGhostsSystem : ISystem
    {
        ...
        public void OnCreate(ref SystemState state)
        {
            ...
            var atype = new NativeArray<ComponentType>(1, Allocator.TempJob);
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            var subScenesWithGhosts = m_UninitializedScenes.ToComponentDataArray<SubSceneWithPrespawnGhosts>(Allocator.TempJob);
            var subSceneEntities = m_UninitializedScenes.ToEntityArray(Allocator.TempJob);

...
//need to implement UnsafeUtility.IsUnmanaged in dotsrt for this to work
            ...
            WorldSystemFilterFlags requiredFlags = 0)
        {
            ...
            var tempFilteredSystemTypes = new NativeList<SystemTypeIndex>(s_SystemTypes.Count-1, Allocator.TempJob);
        ...
        public static void SortSystemTypesInCreationOrder(List<Type> systemTypes)
        {
            ...
            var indices = new NativeList<SystemTypeIndex>(systemTypes.Count, Allocator.TempJob);
        ...
        {
            var systemElements = new UnsafeList<ComponentSystemSorter.SystemElement>(indices.Length, Allocator.TempJob);
            ...
            var lookupDictionary = new NativeHashMap<SystemTypeIndex, int>(systemElements.Length, Allocator.TempJob);
            ...
            var badSystemTypeIndices = new NativeHashSet<SystemTypeIndex>(16, Allocator.TempJob);

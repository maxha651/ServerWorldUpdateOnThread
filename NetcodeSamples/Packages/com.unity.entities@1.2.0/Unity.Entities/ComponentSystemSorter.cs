    ...
    internal class ComponentSystemSorter
    {
        private struct Heap
        {
            ...
            public Heap(int capacity)
            {
                ...
                _elements = new UnsafeList<TypeHeapElement>(initialCapacity, Allocator.TempJob);
        ...
        {
            var badTypeIndices = new NativeList<SystemTypeIndex>(16, Allocator.TempJob);
            ...
            NativeList<SystemTypeIndex>* badSystemTypeIndices)
        {
            ...
            if (nextOutIndex < elements.Length)
            {
                ...
                */
                ...
                var tmp = new NativeHashSet<int>(nextOutIndex, Allocator.TempJob);
            ...
            UnsafeList<SystemTypeIndex>* finalCycle)
        {
            ...
            var pathSoFarInTypeIndices = new NativeList<int>(16, Allocator.TempJob);
            var visitedSoFarTypeIndices = new NativeHashSet<int>(elements.Length, Allocator.TempJob);

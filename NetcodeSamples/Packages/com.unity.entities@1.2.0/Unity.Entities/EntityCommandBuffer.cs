...
#pragma warning restore 728
                    ...
                    using (ECBChainPriorityQueue chainQueue = new ECBChainPriorityQueue(chainStates,
                        data->m_RecordedChainCount, Allocator.TempJob))
                    {
        ...
        internal struct PlaybackProcessor : IEcbProcessor
        {
            ...
            public void Cleanup()
            {
                ...
                Memory.Unmanaged.Free(playbackState.CreateEntityBatch, Allocator.TempJob);
                Memory.Unmanaged.Free(playbackState.BuffersWithFixUp, Allocator.TempJob);

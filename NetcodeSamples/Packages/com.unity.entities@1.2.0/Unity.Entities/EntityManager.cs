...
namespace Unity.Entities
{
    ...
    public unsafe partial struct EntityManager : IEquatable<EntityManager>
    {
        ...
        {
#if ENABLE_UNITY_COLLECTIONS_CHECKS || UNITY_DOTS_DEBUG
            var query = CreateEntityQuery(new EntityQueryBuilder(Allocator.TempJob).WithAllRW<T>().WithOptions(EntityQueryOptions.IncludeSystems));
            var typeIndex = TypeManager.GetTypeIndex<T>();
        ...
        public void CreateEntity(EntityArchetype archetype, int entityCount)
        {
            ...
            {
                using var entities = CreateEntity(archetype, entityCount, Allocator.TempJob);
                return;
            }
#endif
        ...
        public void CopyEntitiesFrom(EntityManager srcEntityManager, NativeArray<Entity> srcEntities, NativeArray<Entity> outputEntities = default)
        {
            ...
            using (var srcManagerInstances = new NativeArray<Entity>(srcEntities.Length, Allocator.TempJob))
            {
                ...
                var instantiated = new EntityQueryBuilder(Allocator.TempJob)
        ...
        public NativeArray<ComponentType> GetComponentTypes(Entity entity, Allocator allocator = Allocator.TempJob)
        {
        ...
        /// objects.</param>
        /// <returns>An array of ComponentType containing all the types of components associated with the entity.</returns>
        public NativeArray<ComponentType> GetComponentTypes(SystemHandle system, Allocator allocator = Allocator.TempJob)
        {
